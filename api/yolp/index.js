...
var YJYolpHandler = module.exports = function(client){
    var self = this;
    self.client = client;
};
...
["LocalSearch","GeoCoder","ReverseGeoCoder","CassetteSearch","Place","ZipCodeSearch","Get","AddressDirectory","RouteMap","Building","ContentsGeoCoder","ShapeSearch","Distance","GenreCode",
"GetGid","DatumConvert","GetAltitude"].forEach(function(api) {
    Util.extend(proto, require("./" + api));
});

YJYolpHandler.prototype = proto;
